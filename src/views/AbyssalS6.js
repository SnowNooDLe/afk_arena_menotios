...
import start4 from "assets/images/s6/start.jpg";
import visualGuide from "assets/images/s5/visual_guide.jpg";
import boss_combi from "assets/images/s6/combi.webp";
  ...
  return (
    <Fragment>
      ...
      <div id="section1" className="container">
        <h2 onClick={() => setMapOpen(!mapOpen)}>지도</h2>
        <Collapse in={mapOpen}>
          <div>
            <img src={mapImage} />
          </div>
        ...
        <br />
        <br />
        <h2 onClick={() => setRuleOpen(!ruleOpen)}>기본적인 룰</h2>
        <Collapse in={ruleOpen}>
          <div className="basic-rule" ref={rule}>
            <ol>
              <li>
                이런식으로 체력 회복까지 남은 시간 이 표시될경우, 10분 이하
                일때만 공격해주세요. 이 부분은 경고 + 추방 으로도 묶겠습니다.
                <img src={rule1} />
              </li>
              <li>
              ...
              <p>
                ...
                <span style={{ color: "red", fontWeight: "bolder" }}>영지</span>
                가 있다면 가장 이상적인 방법은{" "}
                <span style={{ color: "blue", fontWeight: "bolder" }}>
                  공터
                </span>{" "}
              ...
              <li>
                ...
                <ul>
                  <li>
                    당장 필요한 부분은 아니지만 가까운 미래에 필요하게 되리라
                    믿고 미리 올려 놓습니다.
                  </li>
                  <li>
        ...
        <h2 onClick={() => setGuideOpen(!guideOpen)}>비쥬얼 가이드</h2>
        ...
        <h2 onClick={() => setUnitOpen(!unitOpen)}>스타팅 유닛</h2>
        <Collapse in={unitOpen}>
          <div className="start-units" ref={startUnit}>
            ...
            <p>
              사진에도 있듯이 <strong>참고사항</strong> 정도로만 봐주세요,
              본인의 유닛 풀에 맞게 유동적으로 선택해주시기 바랍니다.
            </p>
            <img src={start4} />
            <img src={start2} />
            <img src={start1} />
        ...
        <h2 onClick={() => setBossOpen(!bossOpen)}>보스조합</h2>
        <Collapse in={bossOpen}>
